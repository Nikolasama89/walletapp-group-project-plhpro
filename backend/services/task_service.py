...
class TaskService:
    ...
    def create_task(self, task_type, title, amount=None, category_id=None,
                    due_date=None, priority=2, notify_days_before=3, notes=None):
        ...
        task = Task(
            task_type=task_type, title=title, amount=amount,
            category_id=category_id, due_date=due_date, priority=priority,
            status="open", notify_days_before=notify_days_before, notes=notes,
        )
    ...
    def update_task(self, task_id, task_type=None, title=None, amount=None,
                    category_id=None, due_date=None, priority=None,
