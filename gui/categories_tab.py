...
class CategoriesTab(ttk.Frame):
    ...
    def add_category(self):
        ...
        #Η καρτέλα κατηγοριών υλοποιεί μια απλή φόρμα εισαγωγής κατηγορίας και budget,
        #  καθώς και πίνακα εμφάνισης των κατηγοριών. 
        # Η χρήση Treeview επιτρέπει πιο καθαρή και δομημένη παρουσίαση των δεδομένων.